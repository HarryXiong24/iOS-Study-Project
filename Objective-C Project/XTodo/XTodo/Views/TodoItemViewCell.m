...
- (void)checkboxTapped:(UIButton *)sender {
    ...
    if (sender.selected) {
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            // Notify the delegate
            if ([self.delegate respondsToSelector:@selector(todoItemViewCell:didTapCheckbox:isSelected:)]) {
                [self.delegate todoItemViewCell:self didTapCheckbox:sender isSelected:sender.selected];
            }
